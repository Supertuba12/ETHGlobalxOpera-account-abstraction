...
describe("DepositPaymaster", async () => {
 ...
 describe('deposit', () => {
  ...
  before(async () => {
   wallet = await new OperaSmartWallet__factory(ethersSigner).deploy(entryPoint.address, await ethersSigner.getAddress(), guardians)
  })
 ...
 describe('#validatePaymasterUserOp', () => {
  ...
  before(async () => {
   ...
   wallet = await new OperaSmartWallet__factory(ethersSigner).deploy(entryPoint.address, walletOwner, guardians)
  })
